...
class MaterialsTest < ApplicationSystemTestCase
  ...
  test "creating a Material" do
    ...
    fill_in "Authorname", with: @material.authorname
    fill_in "Bookname", with: @material.bookname
    fill_in "Departmentid", with: @material.departmentid
    fill_in "Term", with: @material.term
