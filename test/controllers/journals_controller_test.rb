...
class JournalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal" do
    assert_difference('Journal.count') do
      post journals_url, params: { journal: { journalid: @journal.journalid, journalname: @journal.journalname } }
    end
  ...
  test "should update journal" do
    patch journal_url(@journal), params: { journal: { journalid: @journal.journalid, journalname: @journal.journalname } }
