...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { email: @manager.email, gender: @manager.gender, id: @manager.id, intime: @manager.intime, name: @manager.name, phone: @manager.phone, weixin: @manager.weixin } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { email: @manager.email, gender: @manager.gender, id: @manager.id, intime: @manager.intime, name: @manager.name, phone: @manager.phone, weixin: @manager.weixin } }
