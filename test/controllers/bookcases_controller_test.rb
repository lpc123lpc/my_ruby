...
class BookcasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookcase" do
    assert_difference('Bookcase.count') do
      post bookcases_url, params: { bookcase: { bookcaseid: @bookcase.bookcaseid, column: @bookcase.column, floor: @bookcase.floor, line: @bookcase.line, number: @bookcase.number, partition: @bookcase.partition } }
    end
  ...
  test "should update bookcase" do
    patch bookcase_url(@bookcase), params: { bookcase: { bookcaseid: @bookcase.bookcaseid, column: @bookcase.column, floor: @bookcase.floor, line: @bookcase.line, number: @bookcase.number, partition: @bookcase.partition } }
